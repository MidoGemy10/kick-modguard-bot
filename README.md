...
- يتم إرسال كل إجراءات المودات في `LOG_CHANNEL_ID` عند وصول حدث بان/تايم أوت من Kick.
...
البوت يرسل في `LOG_CHANNEL_ID` Embed لأي إجراء مودريشن من Kick:

- بان دائم.
- تايم أوت مؤقت.
- اسم المود على Discord لو مربوط.
- اسم المود على Kick.
- اسم المستخدم المستهدف.
- مدة التايم أوت إن وجدت.
- السبب ووقت الإجراء.

لو الإجراء وصل من Kick لكن المود مش متضاف في النظام، البوت هيبعته برضه في اللوج مع حالة `غير مربوط بديسكورد`.
